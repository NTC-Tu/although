...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Source+Code+Pro:ital,wght@0,300;0,400;0,500;1,300&display=swap&subset=vietnamese">
    <link rel="icon" href="./img/logo.png" type="img/x-icon">
    <title>Món ngon đơn giản dành cho sinh viên</title>
</head>
<body>
    <header>
        <div class="logo">
                    ...
                    <li class="others">
                        ...
                        <ul class="user-out">
                            <li class="user-out-item">
                                <a href="./QLBaiViet-admin.php">Quản lý bài viết</a>
                            </li>
                            <li class="user-out-item">
            ...
            ?>
                <div class="log">
                    <li class="others">
                        ...
                        <ul class="user-out">
                            <li class="user-out-item">
                                <a href="./QLBaiViet-user.php">Quản lý bài viết</a>
                            </li>
                            <li class="user-out-item">
                                <a href="DangXuat.php" name="dangxuat">Đăng xuất</a>
                            </li>
